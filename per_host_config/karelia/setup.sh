...
suse_packages="go go-doc docker transmission wireshark htop tmux rxvt-unicode urxvt-font-size xclip ShellCheck openssh nethogs fakeroot fasd fortune cowsay pavucontrol spotify-easyrpm"
